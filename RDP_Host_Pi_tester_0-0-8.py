...
# Matches the name you configured in Roastmaster App
...
class MockProbeHost:
    ...
    def get_local_ip(self):
        """Helper to find own IP so we can ignore own packets"""
    ...
    def read_incoming(self):
        try:
            ...
            # FILTER: Ignore packets from ourselves (Loopback)
            if addr[0] == self.local_ip:
                return

            message = data.decode('utf-8')
            
            # Only print external packets now
    ...
    def send_syn(self):
        ...
        datagram = {
            ...
            KEY_PAYLOAD: json.dumps(payload_array) # Double Encoded
        }
    ...
    def send_temps(self):
        ...
        datagram = {
            ...
            KEY_SERIAL: HOST_SERIAL,
            KEY_EPOCH: current_epoch,
            KEY_PAYLOAD: json.dumps(payload_list) # Double Encoded
        }
    ...
    def run(self):
        ...
        print(f"Ignoring Loopback from: {self.local_ip}")
