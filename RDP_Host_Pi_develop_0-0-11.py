...
KEY_VALUE = "RPValue"
# KEY_META removed to match working 0-0-1.py
...
class ProbeHost:
    def __init__(self):
        ...
        # RESTORED: Integer Counter for Epoch (Matches 0-0-1.py and Arduino)
        self.send_count = 0  
        ...
        # RESTORED: Simple Network Binding (Matches 0-0-1.py)
    ...
    def init_scd41(self):
        try:
            ...
            self.probes.append({ 
                "channel": 2, "handle": scd, 
                "read_func": lambda s: s.temperature, 
                "val": None, "error": False 
            })
            self.probes.append({ 
                "channel": 3, "handle": scd, 
                "read_func": lambda s: s.relative_humidity, 
                "val": None, "error": False 
            })
            self.probes.append({ 
                "channel": 4, "handle": scd, 
    ...
    def read_incoming(self):
        try:
            ...
            # ROBUST CHECK: Convert both to string to handle int/string mismatches
    ...
    def send_syn(self):
        ...
        datagram = {
            ...
            # RESTORED: Use Integer Counter, not Float Timestamp
