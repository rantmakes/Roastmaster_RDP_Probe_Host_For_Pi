...
# --- Timers (in seconds) ---
# [cite_start]Datasheet advises sending at least once per second [cite: 411]
SYNC_SEND_RATE = 2.0
TEMP_SEND_RATE = 0.5 
...
# [cite_start]Meta Types [cite: 381-388]
META_BT = 3000       
META_ET = 3001       
META_MET = 3002      
META_HEATBOX = 3003  
...
class ProbeHost:
    def __init__(self):
        ...
        # --- FIXED: Uncommonented this line to prevent AttributeError ---
        self.send_count = 0  
        ...
        # --- NETWORK SETUP (Matched to working 0-0-1.py) ---
    ...
    def write_web_log(self, datagram):
        ...
        try:
            ...
            with open(temp_path, 'w') as f:
                # [cite_start]STRICT JSON (No whitespace) to match RDP spec [cite: 476-478]
    ...
    def send_syn(self):
        # We use a proper list/array for the payload here, ensuring it serializes to `[{...}]`
        ...
        datagram = {
            ...
            KEY_PAYLOAD: payload_array # Fixed: Passed as object, not double-encoded string
        }
        
        # [cite_start]STRICT JSON encoding (No spaces) to match RDP spec [cite: 476-478]
    ...
    def send_temps(self):
        ...
        for p in self.probes:
            ...
            event = {
                ...
                KEY_VALUE: val_to_send, # Fixed: Passed as float, not string [cite: 461]
        ...
        datagram = {
            ...
            KEY_SERIAL: HOST_SERIAL,
            KEY_EPOCH: self.send_count,
            KEY_PAYLOAD: payload_list # Fixed: Passed as list object
        }
