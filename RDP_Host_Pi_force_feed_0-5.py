...
class MockProbeHost:
    ...
    def send_temps(self):
        ...
        for item in sensor_data:
            # Reverted to Float, but standard list append
        ...
        datagram = {
            ...
            KEY_SERIAL: HOST_SERIAL,
            KEY_EPOCH: current_epoch,
            # Standard Double-Encoded JSON (Commas are included automatically)
    ...
    def run(self):
        print(f"Roastmaster HOST Started (Standard JSON).")
