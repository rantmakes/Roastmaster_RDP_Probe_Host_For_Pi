...
KEY_VALUE = "RPValue"
# KEY_META removed to match 0-0-1.py
...
class ProbeHost:
    def __init__(self):
        ...
        # Matches 0-0-1.py: Integer Counter
        self.send_count = 0  
        ...
        # Matches 0-0-1.py: Simple socket setup
    ...
    def init_scd41(self):
        try:
            ...
            self.probes.append({ "channel": 2, "handle": scd, "read_func": lambda s: s.temperature, "val": None, "error": False })
            self.probes.append({ "channel": 3, "handle": scd, "read_func": lambda s: s.relative_humidity, "val": None, "error": False })
            self.probes.append({ "channel": 4, "handle": scd, "read_func": lambda s: s.CO2, "val": None, "error": False })
    ...
    def write_web_log(self, datagram):
        ...
        try:
            ...
            with open(temp_path, 'w') as f:
                # Matches 0-0-1.py: Default dump (allows spaces), NO separators argument
    ...
    def send_syn(self):
        ...
        datagram = {
            ...
            # CRITICAL RESTORATION: Double Encode the payload (Stringify it)
            # [cite_start]This matches 'json.dumps(payload_array)' in 0-0-1.py [cite: 337]
            KEY_PAYLOAD: json.dumps(payload_array) 
        }
        
        # Matches 0-0-1.py: Default dumps (allows spaces)
    ...
    def send_temps(self):
        ...
        payload_list = []
        for p in self.probes:
            # Matches 0-0-1.py: Send Value as String "null" or "123.45"
            val_str = "null"
            ...
            event = {
                ...
                KEY_VALUE: val_str # Send as string
            }
        ...
        datagram = {
            ...
            KEY_SERIAL: HOST_SERIAL,
            KEY_EPOCH: self.send_count,
            # CRITICAL RESTORATION: Double Encode the payload
